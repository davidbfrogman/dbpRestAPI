...
namespace dbpRestAPI.DataLayer
{
    ...
    public class dbpDatabaseContext : DbContext
    {
        ...
        public DbSet<PortfolioBook> PorfolioBooks { get; set; }
        ...
        public dbpDatabaseContext() : base("dbpDatabaseConnectionString")
        {
            ...
            this.Database.Connection.ConnectionString = "DataSource = " + HttpContext.Current.Server.MapPath("~/App_Data/DBPSqlCompact.mdf");
